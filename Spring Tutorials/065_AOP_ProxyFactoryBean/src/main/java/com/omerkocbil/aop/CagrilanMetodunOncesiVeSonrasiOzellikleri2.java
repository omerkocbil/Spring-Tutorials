...
public class CagrilanMetodunOncesiVeSonrasiOzellikleri2 implements MethodInterceptor {

	@Override
	public Object invoke(MethodInvocation methodInvocation) throws Throwable {
		// Aynı before metodu gibi çalışır
		System.out.println("");
		System.out.println("2****Çağrılan metodun önceki durumu");
		...
		try{
			...
			System.out.println("2****Çağrılan metodun sonraki durumu");
			return result;
		} catch(IllegalArgumentException e){
			System.out.println("2****Çağrılan metoda istisna gelme durumu");
			throw e;
		} finally{
			System.out.println("");
		}
